...
@Slf4j
@Component
public class LoanRequestedListener {

    private final ObjectMapper om = new ObjectMapper();
    private final DemoEventSSEPublisher uiPublisher;
    private final ReserveBookUseCase reserveBookUseCase;

    public LoanRequestedListener(DemoEventSSEPublisher uiPublisher, ReserveBookUseCase reserveBookUseCase) {
    ...
    public void onLoanRequested(String json,
        ...
        ProcessedEventUtil.checkEvent(LoanRequestedListener.class, incomingEventId);
        ...
        ProcessedEventUtil.saveEvent(LoanRequestedListener.class, incomingEventId);
    }
}
